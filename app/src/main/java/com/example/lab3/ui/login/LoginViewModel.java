...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password) {
        ...
        else if(result instanceof Result.Pass){

            loginResult.setValue(new LoginResult("Niepoprawne hasło " + username));
        }

        else {
            //loginResult.setValue(new LoginResult(R.string.login_failed));
            loginResult.setValue(new LoginResult("Próba rejestracji " + username));
        }
    }
